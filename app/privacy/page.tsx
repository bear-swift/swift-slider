...
const ContentSection = () => {
  return (
    <div className="leading-[32px] text-[16px] px-[24px] pb-[24px]">
      <h1 className="text-[40px] py-[48px] text-center">Privacy Policy</h1>
      <div>
      ...
      <div>
        <h2 className="font-semibold text-[24px] py-[24px]">
          Interpretation and Definitions
        </h2>
        <h2 className="font-semibold text-[24px] pt-[16px]">Interpretation</h2>
        <div>
        ...
        <h2 className="font-semibold text-[24px] pt-[16px]">Definitions</h2>
        ...
        <div className="pl-[32px]">
          ...
          <li>
            ...
            <span>
              ...
              Agreement) refers to Sustainable Star LLC., Khaybar St, Al Arid
              Dist. 13335 – 3955 Riyadh Kingdom of Saudi Arabia.
            </span>
          </li>
          <li>
          ...
          <li>
            ...
            <span> refers to: Saudi Arabia</span>
          </li>
          <li>
          ...
          <li>
            ...
            <span>
              {" "}
              refers to sustainablestar, accessible
              from https://sustainablestar.com.sa
            </span>
          </li>
          <li>
      ...
      <h2 className="font-semibold text-[24px]">Types of Data Collected</h2>
      <h2 className="font-semibold text-[24px]">Personal Data</h2>
      <div>
        <div>
      ...
      <h2 className="font-semibold text-[24px] pt-[16px]">Usage Data</h2>
      <div>
      ...
      <div>
        <h2 className="font-semibold text-[24px] pt-[16px]">
        ...
        <div>
          <div>1. Necessary / Essential Cookies</div>
          <div className="pl-[32px]">
            <li>
          ...
          <div>2. Cookies Policy / Notice Acceptance Cookies</div>
          <div className="pl-[32px]">
            <li>
              <span className="font-semibold">Type: </span>
          ...
          <div>3. Functionality Cookies</div>
          <div className="pl-[32px]">
            <li>
              <span className="font-semibold">Type: </span>
              <span>Persistent Cookies</span>
      ...
      <div>
        <h2 className="font-semibold text-[24px]">Use of Your Peronal Data</h2>
      ...
      <h2 className="font-semibold text-[24px] py-[16px]">
      ...
      <div>
        <h2 className="font-semibold text-[24px] pt-[16px]">Law enforcement</h2>
        <div>
      ...
      <div>
        <h2 className="font-semibold text-[24px] pt-[16px]">Contact Us</h2>
        <div>
          If you have any questions about this Privacy Policy, You can contact
          us:
        </div>
        <div className="pl-[32px]">
          <li>By email: info@sustainablestar.com.sa</li>
          <li>
